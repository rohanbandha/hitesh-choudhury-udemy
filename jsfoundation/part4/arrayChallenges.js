...
let teaTypes = ["herbal tea", "white tea", "masala chaia"]
...
/*
6. You have an array named `popularTeas`  containing `"green tea"`,`"oolongtea"`, and `"chai"`.
...
8. You have two arrays: `europeanCities' containing '"Paris"' and '"Rome"', and `asianCities' containing `"Tokyo" and '"Bangkok"'.
   Merge two hese two arrays into a new array named `worldCities`.
*/
